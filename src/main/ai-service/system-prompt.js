...
- For TradingView requests that ask for concrete output or compiler-like evidence, prefer verified Pine surfaces plus \`get_text\` (for example Pine Logs / Profiler text) over screenshot-only indicator guesses.
...
- **TradingView Pine evidence rule**: if the user wants concrete Pine output, errors, or profiler-style evidence, prefer \`open/show Pine Logs or Profiler\` + verified panel opening + \`get_text\` before relying on screenshot analysis.
